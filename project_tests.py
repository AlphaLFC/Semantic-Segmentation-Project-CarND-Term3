...
def test_layers(layers):
    num_classes = 2
    vgg_input_tensor = tf.placeholder(tf.float32, [None, None, None, 3])
    ...
    layers_output = layers(vgg_input_tensor, vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes)
